...
public class EventLauncher implements Listener {
    ...
    public void onJoin(PlayerJoinEvent e) {
        ...
        String jsonPath = plugin.getDataFolder() + "/players/" + p.getName() + ".json";
        if (!new File(jsonPath).exists()) {
            FileUtils.writeFile(jsonPath, "{\"level\":0,\"exp\":0,\"place\":0}");
        }
        if (e.getPlayer().getLevel().getName().equals(variable.configjson.getJSONObject("pos").getJSONObject("pra").getString("l"))) {
    ...
    public void onQuit(PlayerQuitEvent e) {
        Player p = e.getPlayer();
        if (p.getLevel().getName().equals(variable.configjson.getJSONObject("pos").getJSONObject("pra").getString("l"))) {
    ...
    public void onDrop(PlayerDropItemEvent e) {
        ...
        Player p = e.getPlayer();
        if (p.getLevel().getName().equals(variable.configjson.getJSONObject("pos").getJSONObject("pra").getString("l")) && !variable.configjson.getJSONObject("pra").getBoolean("candrop")) {
            e.setCancelled();
    ...
    public void onEntityDamageByEntityEvent(EntityDamageByEntityEvent e) {
        ...
        if (variable.configjson.getJSONObject("pra").getBoolean("pvpprotect") && en.getLevel().getName().equals(variable.configjson.getJSONObject("pos").getJSONObject("pra").getString("l"))) {
            e.setCancelled();
        }
    }
